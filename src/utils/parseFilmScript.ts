...
export const parseFilmScript = ({ filmScript }: { filmScript: IFilmScript }) => {
    ...
    const prompt = `
      ...
      It has been requested by the client that the genre of this series should be ${genre}  and take place in ${primaryStoryLocation}    
      ...
      The primary language of the series should be ${language} and the main characters should be ${mainCharacterEthnicity}
      ${
